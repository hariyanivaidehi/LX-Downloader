...
const translations: Record<string, any> = {
  en: {
    ...
    developedBy: "Developed by Vaidehi Hariyani & Yagnik Hariyani"
  },
  hi: {
    ...
    developedBy: "वैदेही हरियाणी और याज्ञिक हरियाणी द्वारा विकसित"
  },
  bn: {
    ...
    developedBy: "বৈদেহী হারিয়ানি এবং যাজ্ঞিক হারিয়ানি দ্বারা বিকাশকৃত"
  },
  te: {
    ...
    developedBy: "వైదేహి హరియాణి & యాగ్నిక్ హరియాణి చేత అభివృద్ధి చేయబడింది"
  },
  kn: {
    shareText: "LX-Downloader ಅನ್ನು ಹಂಚಿಕೊಳ್ಳಿ:",
    disclaimer: "ಹಕ್ಕುತ್ಯಾಗ: LX-Downloader ಯಾವುದೇ ರೀತಿಯಲ್ಲಿ ಇನ್‌ಸ್ಟಾಗ್ರಾಮ್, ಅಥವಾ ಯೂಟ್ಯೂಬ್‌ನೊಂದಿಗೆ ಅಧಿಕೃತವಾಗಿ ಸಂಯೋಜನೆ ಹೊಂದಿಲ್ಲ. ನಾವು ನಮ್ಮ ಸರ್ವರ್‌ಗಳಲ್ಲಿ ಯಾವುದೇ ಹಕ್ಕುಸ್ವಾಮ್ಯ ಮಾಧ್ಯಮವನ್ನು ಹೋಸ್ಟ್ ಮಾಡುವುದಿಲ್ಲ.",
    developedBy: "ವೈದೇಹಿ ಹರಿಯಾಣಿ ಮತ್ತು ಯಾಗ್ನಿಕ್ ಹರಿಯಾಣಿ ಅವರಿಂದ ಅಭಿವೃದ್ಧಿಪಡಿಸಲಾಗಿದೆ"
  },
  ml: {
    ...
    developedBy: "വൈദേഹി ഹരിയാനിയും യാഗ്നിക് ഹരിയാനിയും വികസിപ്പിച്ചത്"
  },
  mr: {
    ...
    developedBy: "वैदेही हरियाणी आणि याज्ञिक हरियाणी यांनी विकसित केले"
  }
};
        ...
        >
          ...
          <div className="mt-1 flex items-center justify-center">
            <span className="text-xs sm:text-sm font-black text-slate-800 tracking-wider">
              {t.developedBy || "Developed by Vaidehi Hariyani & Yagnik Hariyani"}
            </span>
          </div>
        </motion.div>
